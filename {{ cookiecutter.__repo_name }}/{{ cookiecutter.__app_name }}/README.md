...
```bash
$ python -m {{ cookiecutter.__app_name }}.make_dataset {your_arguments}
$ python -m {{ cookiecutter.__app_name }}.make_model {your_arguments}
$ python -m {{ cookiecutter.__app_name }}.compare_models {your_arguments}
```
...
```bash
$ python -m {{ cookiecutter.__app_name }}.dataset.make_dataset {your_arguments}
$ python -m {{ cookiecutter.__app_name }}.models.make_model {your_arguments}
$ python -m {{ cookiecutter.__app_name }}.visualization.compare_models {your_arguments}
```
